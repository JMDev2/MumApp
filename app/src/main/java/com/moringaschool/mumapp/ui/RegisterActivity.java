...
public class RegisterActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            updateUserInfo( name ,pickedImgUri,mAuth.getCurrentUser(),phone,email);
    ...
    private void updateUserInfo(final String name, Uri pickedImgUri, final FirebaseUser currentUser,String phone, String email) {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            UserFirebase FirebaseUser = new UserFirebase(name,"", "", phone, "", email,user.getPhotoUrl().toString(),0,0,0,uid);
